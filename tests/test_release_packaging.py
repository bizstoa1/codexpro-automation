...
def test_manifest_covers_runtime_and_schemas() -> None:
    ...
    required = {
        ...
        'bin/chatgpt_oracle_archived_contract.py',
        'bin/chatgpt_oracle_archived_report.py',
        'bin/chatgpt_oracle_archived_settlement.py',
        'bin/chatgpt_oracle_multi.py',
        'bin/chatgpt_oracle_multi_artifacts.py',
        'bin/chatgpt_oracle_multi_attestation.py',
        'bin/chatgpt_oracle_multi_core.py',
        'bin/chatgpt_oracle_multi_execution.py',
        'bin/chatgpt_oracle_multi_reconcile.py',
        'bin/chatgpt_oracle_multi_recovery.py',
        ...
        'bin/chatgpt_capability_profile.py',
        'bin/chatgpt_capability_recovery.py',
        'bin/chatgpt_capability_runtime.py',
        'bin/chatgpt_capability_session.py',
        'bin/chatgpt_capability_token.py',
        'bin/chatgpt_project_capability.py',
        'bin/chatgpt_web_multi_capability.py',
        ...
        'contracts/capability-host-policy-v1.schema.json',
        'contracts/oracle-multi-v2.schema.json',
        'contracts/oracle-multi-result-v2.schema.json',
        'contracts/oracle-multi-completion-attestation-v1.schema.json',
        'contracts/pro-mission-authority-v1.schema.json',
        'contracts/project-capability-lease-v1.schema.json',
        'contracts/project-capability-profile-v1.schema.json',
        'contracts/project-capability-v1.schema.json',
